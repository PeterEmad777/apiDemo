...
Product.create([
  ...
  },
  {
    ...
    brand: "Crazepony",
    price: "$88.79",
    description: "Crazypony Quad Rotor Open Source PCB Development Platform for Student Maker Geeker"
  },
  {
    name: "CJ890 Series Desktop Curved Monitor",
    brand: "Samsung",
    price: "$1099.79",
    description: "49 inch 3840x1000 Super Ultra-Wide Desktop Monitor for Business, 144 Hz, USB-C, HDMI, DisplayPort, 3-Year Warranty (C49J890DKN)"
  },
])